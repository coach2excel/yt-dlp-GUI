...
TODO List：
yt-dlp Jet's GUI 改进：
	增加: link download history list
	增加：save download link list to log file, and mark unfinished link to show it next time.
	增加：vimeo download (按link自动识别）
"""

"""
升级记录：
2023-03-17: 
-删除信息输出方式一，只保存更能实时显示的信息
